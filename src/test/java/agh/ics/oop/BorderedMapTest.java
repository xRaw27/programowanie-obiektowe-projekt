...
public class BorderedMapTest {

    @Test
    public void getNewPositionTest() {
        BorderedMap map1 = new BorderedMap(4, 2, 3, 1);
        BorderedMap map2 = new BorderedMap(19, 10, 4, 8);

        assertEquals(new Vector2d(3, 1), map1.getNewPosition(new Vector2d(3, 1), new Vector2d(4, 2)));
        assertEquals(new Vector2d(0, 0), map1.getNewPosition(new Vector2d(0, 0), new Vector2d(0, -1)));
        assertEquals(new Vector2d(1, 0), map1.getNewPosition(new Vector2d(1, 0), new Vector2d(2, -1)));
        assertEquals(new Vector2d(0, 1), map1.getNewPosition(new Vector2d(0, 1), new Vector2d(-1, 4)));
        ...
        assertEquals(new Vector2d(9, 9), map2.getNewPosition(new Vector2d(9, 9), new Vector2d(9, 10)));
        assertEquals(new Vector2d(0, 6), map2.getNewPosition(new Vector2d(0, 6), new Vector2d(-1, 7)));
        assertEquals(new Vector2d(13, 0), map2.getNewPosition(new Vector2d(13, 0), new Vector2d(12, -1)));
        assertEquals(new Vector2d(18, 0), map2.getNewPosition(new Vector2d(18, 0), new Vector2d(19, -1)));
    ...
    public void borderedMapIntegrationTest() {
        BorderedMap map1 = new BorderedMap(19, 10, 4, 8);
